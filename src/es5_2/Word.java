...
public class Word extends Token {
	...
	public static final Word cond = new Word(Tag.COND, "cond"), when = new Word(Tag.WHEN, "when"),
			...
			print = new Word(Tag.PRINT, "print"), read = new Word(Tag.READ, "read"), lt = new Word(Tag.RELOP, "<"), gt = new Word(Tag.RELOP, ">"),
			eq = new Word(Tag.RELOP, "=="), le = new Word(Tag.RELOP, "<="), ne = new Word(Tag.RELOP, "<>"),
			ge = new Word(Tag.RELOP, ">="), 
			// or-and-not
			or = new Word(Tag.OR, "||"),and = new Word(Tag.AND, "&&"),not = new Word(Tag.NOT, "!");
}
