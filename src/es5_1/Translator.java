...
• Si noti che questa modifica è possibile grazie
alla particolarità delle istruzioni cond e while.
• Cioè nel caso in cui la condizione <bexpr> è
...
public class Translator {
	...
	public void stat_p(int lnext) {
		...
		case Tag.READ:
			...
			break;
/*init_case: lable di partenza per il valutatore, che ci sia 'else' oppure no, dopo la valutazione il programma andrÃ  a next_case*/
		case Tag.COND:
	...
	/*
	 * BEXPR_Pâ†’ RELOP EXPR EXPR GUIDA relop
	 */
	...
	/*
	 * EXPR_P â†’ + EXPR_LIST EXPR_P â†’- EXPR EXPR EXPR_P â†’ * EXPR_LIST EXPR_P â†’ / EXPR
	 * EXPR
	 * 
	 * GUIDA + - * /
	 */
	...
	/*
	 * EXPR_LIST_Pâ†’EXPR EXPR_LIST_P EXPR_LIST_Pâ†’Îµ
	 * 
